...
public class RobotContainer {
    ...
    // TODO fix this, controls should all be defined in thesame place, this is all
    // pre-gen CTRE code that youll need to change

    // Look at last years chassis states code, trace the code, figure out how it
    // works and implement it here becuase this hurts
