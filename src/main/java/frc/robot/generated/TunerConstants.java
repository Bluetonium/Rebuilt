...
public class TunerConstants {
    ...
    //---------------maybe use this later for drive and steer limits (right below here)
    //private static final Current overallCurrentLimit = Amps.of(30);

    // Initial configs for the drive and steer motors and the azimuth encoder; these cannot be null.
    // Some configs will be overwritten; check the `with*InitialConfigs()` API documentation.\


    //kaiden check this keyword currentlimitnow
    //this is where you actually set current limits
    ...
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                ...
                //brownouts are more related to supply limits i believe rather than stator limit
                //however stator limit does effectively change the supply current limit as well i think
                .withStatorCurrentLimit(Amps.of(30))
                .withStatorCurrentLimitEnable(true)
                .withSupplyCurrentLimit(Amps.of(30))
                .withSupplyCurrentLimitEnable(true)
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.471923828125);
