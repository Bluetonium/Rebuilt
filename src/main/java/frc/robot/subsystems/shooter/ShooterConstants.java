...
public class ShooterConstants {
        public static final double ACCELERATION = 90;// in RPS/s
        public static final double FORWARD_VELOCITY = -1;// in RPS
        public static final double BACKWARD_VELOCITY = 1;// in RPS
        ...
        public static final CurrentLimitsConfigs CURRENT_LIMITS = new CurrentLimitsConfigs()
                        ...
                        .withSupplyCurrentLimit(30);// keep this bellow 40 idealy, this is how much power it should be
                                                    // able to take
                                                    // from the PDH, 60 is too much (ps all of the supply currents of
                                                    // everything
